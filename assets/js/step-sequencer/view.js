import { Element as E, Attribute as A } from '@flow-lang/framework/dist/dom'

// View ------------------------------------------------------------------------
export default function view ({ sequencer, synth }) {
  ...
  return E.main([ classes ], [
    ...
    // Sequencer steps ---------------------------------------------------------
    E.section([], [
      E.h2([ A.className('text-lg font-bold') ], [ `Current step: ${sequencer.step}` ]),
...
// Utils -----------------------------------------------------------------------
// Tailwind is a utility-first CSS library. Classes on elements tend to get very
// long when using Tailwind so this function allows us to split our CSS classes
// into a few different categories like `typography` or `spacing` and then
// simply joins them together with a space character and calls the className
// function.
